package com.xunqi.gulimall.serurity.handler;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.serializer.SerializerFeature;
import com.xunqi.gulimall.config.redis.RedisService;
import com.xunqi.gulimall.user.entity.User;
import com.xunqi.gulimall.utils.vueadminelementui.JwtUtils;
import com.xunqi.gulimall.utils.vueadminelementui.LoginResult;
import com.xunqi.gulimall.utils.vueadminelementui.ResultCode;
...
public class LoginSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        //创建登录结果对象
        LoginResult loginResult = new LoginResult(user.getUserId(), ResultCode.SUCCESS, token, expireTime);
        //消除循环引用
